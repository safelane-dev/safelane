...
| `safelane register <selection-json-path\|->` | Validate the selection and write the configuration. |
...
Use `--app <application>` when repository matching is not unique. Use `--json` for structured output.
